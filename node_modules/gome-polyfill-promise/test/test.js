(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["testPromise"] = factory();
	else
		root["testPromise"] = factory();
...
describe('Promise.resovle', function () {
	it('thenable正常', function (done) {
		var a = {
			then: function then(resolve) {
				resolve('resolve');
			}
		};
		Promise.resolve(a).then(function (result) {
			expect(result).to.equal('resolve');
			done();
		});
	});
	it('thenable异常', function (done) {
		var a = {
			then: function then(resolve) {
	...
	it('promise正常', function (done) {
		var pro = new Promise(function (resolve, reject) {
			resolve('resolve');
		});
		Promise.resolve(pro).then(function (data) {
			expect(data).to.equal('resolve');
			done();
		});
	});
	it('promise异常', function (done) {
		var pro = new Promise(function (resolve, reject) {
			reject('reject');
		});
		Promise.resolve(pro).then(function (data) {
	...
	it('各种直接值', function (done) {
		Promise.resolve(1).then(function (data) {
			expect(data).to.equal(1);
		});
		var arr = [];
		Promise.resolve(arr).then(function (data) {
 ...
 * @Last Modified time: 2018-04-18 19:42:47
...
var Promise = function () {
    ...
    _createClass(Promise, [{
                ...
                try {
                    ...
                    if (status == 'fulfilled') {
                        if (!retriver.onfulfilled) {
                            ...
                            x = retriver.onfulfilled.call(undefined, this._PromiseValue);
                        }
                ...
                if (x._PromiseStatus == 'pending') {
                    ...
                    x.then(function (x) {
                        ...
                        if (then.throwed) {
                            ...
                            promise2._decide('fulfilled', x);
                        }
                    }, function (r) {
                        promise2._decide('rejected', r);
                    });
                    // 2.3.2.2 如果x是fulfilled状态，将x的值用于fulfill promise
                } else if (x._PromiseStatus == 'fulfilled') {
                    // // 递归去解决吧=。=
        ...
        /**
         * promise实例的取值器
         * @param {*} onfulfilled 如果promise实例是fulfilled状态，执行onfulfilled回调
