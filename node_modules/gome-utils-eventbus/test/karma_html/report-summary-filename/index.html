...
<title>report-summary-filename</title>
<style>
...
<h1>Tested in Chrome 61.0.3163 (Windows 10 0.0.0) on Mon Oct 30 2017</h1>
...
<div class="alert">
  ...
  <a href="#" onclick="unfold();">Unfold</a></span>13 specs, 0 failed, 0 pending</span>
...
<div class="results">
  <div class="summary">
    ...
    <div class="suite passed">
      <span class="description">eventbus.emit 发出消息test</span>
    
      <div class="specSummary passed">
      <span class="description">不报错</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.on 发出消息</span>
    
      <div class="specSummary passed">
      <span class="description">callback接受到消息test</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.on 发出消息且带上参数,字符串str_test</span>
    
      <div class="specSummary passed">
      <span class="description">callback接受到消息和参数，且参数为str_test</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.on 发出消息且带上参数,数字12</span>
    
      <div class="specSummary passed">
      <span class="description">callback接受到消息和参数，且参数为12</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.on 发出消息且带上数组[1, 2]</span>
    
      <div class="specSummary passed">
      <span class="description">callback接受到消息和参数，且参数为[1, 2]</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.on 发出5次消息</span>
    
      <div class="specSummary passed">
      <span class="description">接到5次消息</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.off 发出5次消息，侦听一次消息，然后取消侦听</span>
    
      <div class="specSummary passed">
      <span class="description">只侦听到一次消息</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.once 发出5次消息，侦听一次消息</span>
    ...
    <div class="suite passed">
      <span class="description">eventbus.only 建立五个侦听器，发出一次消息</span>
    
      <div class="specSummary passed">
      <span class="description">只有一个侦听器侦听到消息</span>
      </div>
    
      <div class="specSummary passed">
      <span class="description">只有最后一个侦听器侦听到消息</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.emitDOM 发出一个消息</span>
    
      <div class="specSummary passed">
      <span class="description">用window.addEventListener侦听到消息</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.emitDOM 发出一个带参数的消息</span>
    
      <div class="specSummary passed">
      <span class="description">侦听到消息和参数</span>
      </div>
    
    </div>
  
    <div class="suite passed">
      <span class="description">eventbus.emitDOM 以document.body发出一个消息</span>
